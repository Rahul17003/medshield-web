        ...
        return (
            <Layout>
                ...
                <Form onSubmit={this.onSubmit} error={!!this.state.errorMessage}>
                    ...
                    <Button primary loading={this.state.loading} style={{backgroundColor: '#4F46E5', borderRadius: '9999px', color: '#FFF', padding: '1.1rem 1.5rem', cursor: 'pointer', transition: 'background-color 0.3s ease' }}
            onMouseOver={(e) => e.currentTarget.style.backgroundColor = '#4338CA'}
            onMouseOut={(e) => e.currentTarget.style.backgroundColor = '#4F46E5'} >Register</Button>
                </Form>
                </Segment>
            </Layout>
        );
